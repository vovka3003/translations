...
$LANG["word_advanced"] = "TingkatLanjut";
...
$LANG["word_blue"] = "Biru";
$LANG["word_bottom"] = "Bawah";
$LANG["word_cancel"] = "Membatalkan";
$LANG["word_cc_c"] = "Cc:";
$LANG["word_center"] = "Tengah";
...
$LANG["text_add_form_help_link"] = "Jika Anda mengalami masalah apapun selama langkah ini, cobalah membaca keluar <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">dokumentasi pengguna</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Salin dan sisipkan konten dari bagian di bawah ini ke file bernama config.php dan upload melalui FTP ke Formulir Tools / global folder (folder yang juga berisi beberapa file dan direktori yang lain, satu file bernama license.txt).";
...
$LANG["text_enter_license_key"] = "Dalam rangka untuk menginstal modul ini, Anda harus memasukkan kunci lisensi Anda. Anda harus sudah diemail tombol ini setelah membeli modul. Jika Anda tidak menerimanya, Anda selalu dapat <a href=\"http://accounts.formtools.org\" target=\"_blank\">login ke akun Alat Formulir Anda</a> untuk menelusurinya.";
...
$LANG["text_install_email_content_text"] = "Ada banyak sumber daya di website kami untuk membantu Anda memulai, termasuk dokumentasi online kami (http://docs.formtools.org) dan tutorial (http://docs.formtools.org/tutorials). Jika Anda menemukan Anda buntu atau memiliki pertanyaan, pop oleh forum (http://forums.formtools.org) dan menyapa.";
$LANG["text_install_form_tools_server_not_supported"] = "Maaf, Alat Formulir tidak akan dapat menjalankan pada server Anda. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Silahkan klik di sini</a> untuk persyaratan minimum.";
...
$LANG["text_no_themes"] = "Anda tidak memiliki tema yang ditetapkan. Klik tombol di bawah ini untuk menyegarkan daftar tema Anda, atau periksa <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">Formulir Alat dokumentasi pengguna</a> untuk informasi tentang menambahkan tema.";
...
$LANG["notify_file_not_deleted_no_exist"] = "File ini belum dihapus karena tidak ada di lokasi yang diharapkan. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan pesan kesalahan ini dan hanya menghapus referensi dari database.";
$LANG["notify_file_not_deleted_permissions"] = "File ini belum dihapus karena memiliki perizinan yang salah. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan pesan kesalahan ini dan hanya menghapus referensi dari database.";
$LANG["notify_file_not_deleted_unknown_error"] = "Ada kesalahan tak dikenal ketika mencoba untuk menghapus file ini. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan pesan kesalahan ini dan hanya menghapus referensi dari database.";
