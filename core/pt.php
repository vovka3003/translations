...
$LANG["phrase_allow_toolbar_resizing"] = "Permitir redimensionamento da barra de ferramentas";
...
$LANG["phrase_get_more"] = "Obtenha mais ...";
...
$LANG["phrase_problems_questions_forum"] = "Problemas / questões? Visite nossos fóruns";
...
$LANG["text_add_form_help_link"] = "Se você tiver qualquer problema durante essas etapas, tente ler em <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">documentação do usuário</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Copie e cole o conteúdo da seção abaixo em um arquivo chamado config.php e enviá-lo via FTP para as ferramentas de formulário / pasta global (na pasta que contém também alguns outros arquivos e diretórios, um arquivo chamado license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Antes de continuar, você terá de atualizar seu <b>/ themes / default</b> pasta <b>/ cache</b> para permitir a plena leitura e escrita permissões. Uma vez feito isso, essa mensagem desaparecerá e você pode instalar o script.";
...
$LANG["text_enter_license_key"] = "A fim de instalar este módulo, você deve digitar sua chave de licença. Você deveria ter sido enviada esta tecla depois de comprar o módulo. Se você não recebê-lo, você sempre pode <a href=\"http://accounts.formtools.org\" target=\"_blank\">entrar em sua conta Tools Formulário</a> para rastreá-lo.";
...
$LANG["text_install_already_upgraded"] = "Se você já tiver executado o script de instalação, exclua o arquivo <b>/</b> pasta de <b>instalação,</b> em seguida, <a href=\"../\" class=\"bold\">clique aqui para iniciar sessão.</a>";
...
$LANG["text_install_email_content_text"] = "Há uma abundância de recursos em nosso site para ajudar você a começar, incluindo a nossa documentação on-line (http://docs.formtools.org) e tutoriais (http://docs.formtools.org/tutorials). Se você achar que ficar preso ou tem uma pergunta, pop pelos nossos fóruns (http://forums.formtools.org) e dizer Olá.";
$LANG["text_install_form_tools_server_not_supported"] = "Desculpe, Ferramentas de formulário não será capaz de rodar em seu servidor. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Por favor, clique aqui</a> para a requisitos mínimos.";
...
$LANG["text_must_delete_install_folder"] = "Antes de efetuar login <b>você deve excluir o install / pasta no seu servidor.</b> Não será permitido o login antes de ter sido removido.";
...
$LANG["text_no_themes"] = "Você não tem nenhum tema definido. Clique no botão abaixo para atualizar sua lista de tema, ou verifique a <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">documentação do usuário Form Tools</a> para obter informações sobre a adição de temas.";
...
$LANG["notify_file_not_deleted_no_exist"] = "O arquivo não foi excluído porque não existe no local esperado. <a href=\"#\" onclick=\"{\$js_link}\">Clique aqui</a> para ignorar esta mensagem de erro e apenas remover a referência do banco de dados.";
$LANG["notify_file_not_deleted_permissions"] = "O arquivo não foi excluído porque não tem as permissões erradas. <a href=\"#\" onclick=\"{\$js_link}\">Clique aqui</a> para ignorar esta mensagem de erro e apenas remover a referência do banco de dados.";
$LANG["notify_file_not_deleted_unknown_error"] = "Houve um erro desconhecido ao tentar excluir este arquivo. <a href=\"#\" onclick=\"{\$js_link}\">Clique aqui</a> para ignorar esta mensagem de erro e apenas remover a referência do banco de dados.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "O módulo foi desinstalado. Nota: não foi possível excluir o módulo de sua pasta modules / - você vai precisar para excluí-lo manualmente.";
...
$LANG["notify_no_user_email_fields_configured"] = "Observação: se você quiser enviar um e-mail para qualquer endereço de e-mail que foi incluído no formulário, você primeiro precisa <a href=\"{\$same_page}?page=email_settings\">configurar os campos de e-mail forma.</a>";
