...
$LANG["phrase_allow_toolbar_resizing"] = "Izinkan Toolbar Resizing";
...
$LANG["phrase_problems_questions_forum"] = "Masalah / Soalan? Lawati forum kami";
...
$LANG["text_add_form_help_link"] = "Jika anda menghadapi masalah apa-apa semasa langkah-langkah ini, cuba membaca <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">dokumentasi pengguna</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Salin dan tampal kandungan daripada bahagian di bawah ini ke file bernama config.php dan upload melalui FTP ke Borang Tools / global folder (folder yang juga mengandungi beberapa fail dan direktori yang lain, satu fail bernama license.txt).";
...
$LANG["text_enter_license_key"] = "Untuk memasang modul ini, anda mesti memasukkan kunci lesen anda. Anda harus mempunyai e-mel kunci ini selepas membeli modul. Jika anda tidak menerimanya, anda boleh <a href=\"http://accounts.formtools.org\" target=\"_blank\">log masuk ke akaun Borang Tools anda</a> untuk mengesan.";
...
$LANG["text_install_email_content_text"] = "Ada banyak sumber di website kami untuk membantu anda memulakan, termasuk dokumentasi talian kami (http://docs.formtools.org) dan tutorial (http://docs.formtools.org/tutorials). Jika anda mendapati anda buntu atau mempunyai pertanyaan, pop oleh forum (http://forums.formtools.org) dan menyapa.";
$LANG["text_install_form_tools_server_not_supported"] = "Maaf, Peralatan Borang tidak akan dapat berjalan pada pelayan anda. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Sila klik di sini</a> untuk keperluan minimum.";
...
$LANG["text_no_themes"] = "Anda tidak mempunyai apa-apa tema yang telah ditentukan. Klik butang di bawah untuk muat semula senarai tema anda, atau <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">mendaftar Borang Tools dokumentasi</a> pengguna untuk mendapatkan maklumat tentang menambah tema .";
...
$LANG["notify_file_not_deleted_no_exist"] = "Gambar ini belum dihapuskan kerana tidak ada di lokasi yang diharapkan. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan mesej kesalahan ini dan hanya memadam rujukan daripada database.";
$LANG["notify_file_not_deleted_permissions"] = "Gambar ini belum dihapuskan kerana memiliki perizinan yang salah. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan mesej kesalahan ini dan hanya memadam rujukan daripada database.";
$LANG["notify_file_not_deleted_unknown_error"] = "Ada kesalahan tak dikenali ketika cuba untuk memadam fail ini. <a href=\"#\" onclick=\"{\$js_link}\">Klik di sini</a> untuk mengabaikan mesej kesalahan ini dan hanya memadam rujukan daripada database.";
