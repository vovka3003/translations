...
$LANG["word_html"] = "HTML";
$LANG["word_id"] = "ID";
$LANG["word_ignore"] = "Pasar por alto";
$LANG["word_ignore"] = "Pasar por alto";
...
$LANG["word_today"] = "Hoy";
$LANG["word_toolbar"] = "Barra de herramientas";
$LANG["word_top"] = "Superior";
...
$LANG["phrase_allow_toolbar_resizing"] = "Permitir cambiar tamaño de la Barra de Herramientas";
...
$LANG["phrase_problems_questions_forum"] = "Problemas / preguntas? Visita nuestros foros";
...
$LANG["text_add_form_help_link"] = "Si surge algún problema durante estos pasos, pruebe la lectura de <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">la documentación del usuario</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Copia y pega el contenido de la sección a continuación en un archivo de nombre config.php y cárgalo vía FTP a la carpeta <b>/global</b> del directorio de Form Tools. (Una carpeta que contiene otros directorios y algunos archivos, entre esos uno llamado license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Antes de continuar, tendrá que actualizar su carpeta<b>/themes/default/cache</b> para permitir acceso total de lectura y escritura. Una vez hecho esto, este mensaje desaparecerá y usted podrá instalar la secuencia de comandos.";
...
$LANG["text_enter_license_key"] = "Para poder instalar este módulo, usted debe ingresar su clave de licencia. Usted debería haber sido enviado por correo electrónico esta tecla después de comprar el módulo. Si no lo recibe, siempre se puede <a href=\"http://accounts.formtools.org\" target=\"_blank\">acceder a su cuenta de Herramientas para el Formulario</a> para la pista.";
...
$LANG["text_install_email_content_text"] = "Hay un montón de recursos en nuestro sitio web para ayudarte a comenzar, incluyendo nuestra documentación en línea (http://docs.formtools.org) y tutoriales (http://docs.formtools.org/tutorials). Si usted encuentra que alguna dificultad o tiene una pregunta, pop de nuestros foros (http://forums.formtools.org) y decir hola.";
$LANG["text_install_form_tools_server_not_supported"] = "Lo sentimos, herramientas de forma que no será capaz de ejecutar en el servidor. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Por favor, haga clic aquí</a> para los requisitos mínimos.";
...
$LANG["text_no_themes"] = "Usted no tiene ninguna temas definidos. Haga clic en el botón de abajo para actualizar su lista de temas, o comprobar la <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">documentación del Formulario de herramientas de usuario</a> para obtener información sobre cómo agregar temas.";
...
$LANG["notify_file_not_deleted_no_exist"] = "El archivo no pudo eliminarse debido a que no se encontró en el lugar esperado. <a href=\"#\" onclick=\"{\$js_link}\">Haz clic aquí</a> para ignorar este mensaje de error y simplemente eliminar la referencia a este archivo de la base de datos.";
$LANG["notify_file_not_deleted_permissions"] = "El archivo fue eliminado porque tiene los permisos incorrectos. <a href=\"#\" onclick=\"{\$js_link}\">Haz clic aquí</a> para ignorar este mensaje de error y simplemente eliminar la referencia a este archivo de la base de datos.";
$LANG["notify_file_not_deleted_unknown_error"] = "Se ha producido un error desconocido al intentar eliminar este archivo. <a href=\"#\" onclick=\"{\$js_link}\">Hza clic aquí</a> para ignorar este mensaje de error y simplemente eliminar la referencia a este archivo de la base de datos.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "El módulo ha sido desinstalado. Nota: No hemos podido eliminar el módulo de la carpeta /modules - tendrás que borrarlo manualmente.";
