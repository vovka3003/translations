...
$LANG["word_display"] = "Відображати";
$LANG["word_documentation"] = "Документація";
$LANG["word_done"] = "Зроблений";
$LANG["word_download"] = "Завантаження";
...
$LANG["phrase_allow_toolbar_resizing"] = "Дозволити зміну розмірів панелі інструментів";
...
$LANG["phrase_get_more"] = "Отримати більше ...";
...
$LANG["text_add_form_help_link"] = "Якщо у вас виникли будь-які проблеми під час цих кроків, спробуйте прочитати з <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">користувацької документації</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Скопіюйте та вставте вміст з розділу нижче в файл config.php і завантажте його через FTP до форми Інструменти / глобальні папки (папки, яка містить також кілька інших файлів і каталогів, один файл з назвою license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Перш ніж продовжувати, вам потрібно відновити <b>/ Теми / Default /</b> папці <b>кешу</b> для забезпечення повного читання і запис. Як тільки це буде зроблено, це повідомлення зникне, і ви можете встановити скрипт.";
...
$LANG["text_enter_license_key"] = "Для того щоб встановити цей модуль, ви повинні ввести ліцензійний ключ. Ви повинні були цей ключ по електронній пошті після покупки модуля. Якщо ви не отримали його, ви завжди можете <a href=\"http://accounts.formtools.org\" target=\"_blank\">увійти в свій аккаунт Форма інструменти</a> для відстеження його вниз.";
...
$LANG["text_install_already_upgraded"] = "Якщо ви вже запустили сценарій встановлення, видалення <b>/ Встановити</b> папку, потім <a href=\"../\" class=\"bold\">натисніть тут, щоб увійти.</a>";
...
$LANG["text_install_email_content_text"] = "Там є багато ресурсів на нашому сайті, щоб допомогти вам розпочати роботу, у тому числі наш онлайн документацію (http://docs.formtools.org) і підручники (http://docs.formtools.org/tutorials). Якщо ви виявите ви заплутаєтеся чи є питання, наші поп-форумах (http://forums.formtools.org) і привітатися.";
$LANG["text_install_form_tools_server_not_supported"] = "На жаль, форма інструменти не будуть мати можливість запускати на вашому сервері. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Будь ласка, натисніть тут</a> для мінімальних вимог.";
...
$LANG["text_must_delete_install_folder"] = "Перш ніж увійти <b>Ви повинні видалити / установка / папки на вашому сервері.</b> Вам не буде дозволено ввійти в систему, поки вона не була вилучена.";
...
$LANG["text_no_themes"] = "У вас немає жодної теми визначена. Натисніть на кнопку нижче, щоб освіжити свою тему списку, або перевірити <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">користувача Форма Інструменти документації</a> для отримання інформації про додавання теми.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">Натисніть тут,</a> щоб вказати, які поля форми електронної пошти поля, так що ви можете націлити їх в шаблонах електронної пошти.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Файл не був вилучений, тому що не існує на місці очікував. <a href=\"#\" onclick=\"{\$js_link}\">Натисніть тут,</a> щоб проігнорувати це повідомлення про помилку і просто видалити посилання з бази даних.";
$LANG["notify_file_not_deleted_permissions"] = "Файл не був знищений, оскільки він має неправильні права. <a href=\"#\" onclick=\"{\$js_link}\">Натисніть тут,</a> щоб проігнорувати це повідомлення про помилку і просто видалити посилання з бази даних.";
$LANG["notify_file_not_deleted_unknown_error"] = "Був Невідома помилка при спробі видалити цей файл. <a href=\"#\" onclick=\"{\$js_link}\">Натисніть тут,</a> щоб проігнорувати це повідомлення про помилку і просто видалити посилання з бази даних.";
...
$LANG["notify_install_no_db_connection"] = "Будь ласка, перевірте ім&#39;я бази даних і Логін інформації. Хоча нам вдалося підключитися до бази даних господаря, ми не могли підключитися до бази даних. Повідомлення про помилку бази даних повертаються: <i>{\$db_select_error}</i>";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Цей модуль був вилучений. Примітка: Ми не могли видалити модуль з файлу / папки модулів - вам необхідно видалити його вручну.";
...
$LANG["notify_no_user_email_fields_configured"] = "Примітка: якщо ви хочете відправити повідомлення на будь-яку адресу електронної пошти, який був включений у формі, спочатку необхідно <a href=\"{\$same_page}?page=email_settings\">налаштувати поля форми електронною поштою.</a>";
