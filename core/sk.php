...
$LANG["word_advanced"] = "Rozšírené";
$LANG["word_after"] = "Potom";
$LANG["word_all"] = "všetko";
...
$LANG["phrase_allow_toolbar_resizing"] = "Povoliť zmenu veľkosti Toolbar";
...
$LANG["text_add_form_help_link"] = "Ak narazíte na nejaké problémy pri týchto krokoch, skúste si prečítať z <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">užívateľskej dokumentácie</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Skopírovať a vložiť obsah z časti dole na súbor s názvom config.php a nahrať cez FTP na formulári Nástroje / globálny zložky (zložky, ktorá obsahuje aj niekoľko ďalších súborov a adresárov, jeden súbor s názvom license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Než budeme pokračovať, budete musieť aktualizovať <b>/ themes / default / cache</b> zložky povoliť plný čítanie a zápis. Akonáhle máte hotovo, bude táto správa zmizne a môžete nainštalovať skript.";
...
$LANG["text_enter_license_key"] = "Na inštaláciu tohto modulu je nutné zadať licenčný kľúč. Tie by mali byť e-mailom tento kľúč po zakúpení modulu. Ak ste nedostali, môžete stále <a href=\"http://accounts.formtools.org\" target=\"_blank\">prihlásiť k svojmu účtu tvarové nástroje</a> sledovať to.";
...
$LANG["text_install_email_content_text"] = "Je tu dosť prostriedkov na našich webových stránkach, ktoré vám pomôžu začať, vrátane nášho on-line dokumentácie (http://docs.formtools.org) a cvičenie (http://docs.formtools.org/tutorials). Ak ste zistili, narazíte na problém alebo si otázku, pop nášho fóra (http://forums.formtools.org) a pozdravit.";
$LANG["text_install_form_tools_server_not_supported"] = "Ospravedlňujeme sa, ale budú tvoriť nástroje nebude môcť bežať na serveri. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Prosím, kliknite tu</a> pre minimálne požiadavky.";
...
$LANG["text_no_themes"] = "Nemáte žiadne definované témy. Kliknite na tlačidlo nižšie, aby ste si osviežili téme zoznamu alebo sa pozrieť <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">tvarové nástroje užívateľskej dokumentácii</a> pre informácie o pridávaní témy.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Súbor nebol zrušený, pretože neexistuje v očakávanom mieste. <a href=\"#\" onclick=\"{\$js_link}\">Kliknite tu</a> pre túto chybovú správu ignorovať a len odstrániť odkaz z databázy.";
$LANG["notify_file_not_deleted_permissions"] = "Súbor nebol zrušený, pretože sa zle nastaveným právam. <a href=\"#\" onclick=\"{\$js_link}\">Kliknite tu</a> pre túto chybovú správu ignorovať a len odstrániť odkaz z databázy.";
$LANG["notify_file_not_deleted_unknown_error"] = "Došlo k bližšie nešpecifikované chybe pri pokuse o zmazanie tohto súboru. <a href=\"#\" onclick=\"{\$js_link}\">Kliknite tu</a> pre túto chybovú správu ignorovať a len odstrániť odkaz z databázy.";
...
$LANG["notify_install_no_db_connection"] = "Skontrolujte prosím svoje meno databázy a prihlasovacie informácie. I keď sme boli schopní sa pripojiť k databáze hostiteľa, ale nemohli sme sa pripojiť k databáze. Chybe databázy vrátil je: <i>{\$db_select_error}</i>";
