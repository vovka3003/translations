...
$LANG["word_toolbar"] = "Панэлі інструментаў";
$LANG["word_top"] = "Верх";
...
$LANG["phrase_allow_toolbar_resizing"] = "Дазволіць змяненне памераў панэлі інструментаў";
...
$LANG["phrase_get_more"] = "Атрымаць больш ...";
...
$LANG["phrase_problems_questions_forum"] = "Праблемы / Пытанні? Наведайце нашы форумы";
...
$LANG["text_add_form_help_link"] = "Калі ў вас узніклі якія-небудзь праблемы падчас гэтых крокаў, паспрабуйце прачытаць з <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">карыстацкай дакументацыі</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Скапіруйце і ўстаўце змесціва з падзелу ніжэй у файл config.php і ўкладання яго праз FTP да форме Скрынка прылад / глабальныя папкі (папкі, якая ўтрымлівае таксама некалькі іншых файлаў і каталогаў, адзін файл з назвай license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Перш чым працягваць, вам трэба абнавіць <b>/ Тэмы / Default /</b> тэчцы <b>кэша</b> для забеспячэння поўнага чытанне і запіс. Як толькі гэта будзе зроблена, гэта паведамленне знікне, і вы можаце ўсталяваць скрыпт.";
...
$LANG["text_enter_license_key"] = "Для таго каб ўсталяваць гэты модуль, вы павінны ўвесці ліцэнзійны ключ. Вы павінны былі гэты ключ па электроннай пошце пасля куплі модуля. Калі вы не атрымалі яго, вы заўсёды можаце <a href=\"http://accounts.formtools.org\" target=\"_blank\">ўвайсці ў свой ​​рахунак Форма прылады</a> для адсочвання яго ўніз.";
...
$LANG["text_install_already_upgraded"] = "Калі вы ўжо запусцілі сцэнарый ўстаноўкі, выдалення <b>/ Устанавіць</b> папку, затым <a href=\"../\" class=\"bold\">націсніце тут, каб увайсці.</a>";
...
$LANG["text_install_email_content_text"] = "Там ёсць шмат рэсурсаў на нашым сайце, каб дапамагчы вам пачаць працу, у тым ліку наш онлайн дакументацыю (http://docs.formtools.org) і падручнікі (http://docs.formtools.org/tutorials). Калі вы выявіце вы заблыталася ці ёсць пытанні, нашы поп-форумах (http://forums.formtools.org) і прывітацца.";
$LANG["text_install_form_tools_server_not_supported"] = "На жаль, форма інструменты не будуць мець магчымасць запускаць на вашым серверы. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Калі ласка, націсніце тут</a> для мінімальных патрабаванняў.";
...
$LANG["text_must_delete_install_folder"] = "Перш чым увайсці <b>Вы павінны выдаліць / ўстаноўка / папкі на вашым серверы.</b> Вам не будзе дазволена ўвайсці ў сістэму, пакуль яна не была выдалена.";
...
$LANG["text_no_themes"] = "У вас няма ні адной тэмы вызначана. Націсніце на кнопку ніжэй, каб асвяжыць сваю тэму спісе, або праверыць <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">карыстальніка Форма Інструменты дакументацыі</a> для атрымання інфармацыі аб даданні тэмы.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Файл не быў выдалены, таму што не існуе на месцы чакаў. <a href=\"#\" onclick=\"{\$js_link}\">Націсніце тут,</a> каб праігнараваць гэта паведамленне пра памылку і проста выдаліць спасылкі з базы дадзеных.";
$LANG["notify_file_not_deleted_permissions"] = "Файл не быў выдалены, паколькі ён мае няправільныя правы. <a href=\"#\" onclick=\"{\$js_link}\">Націсніце тут,</a> каб праігнараваць гэта паведамленне пра памылку і проста выдаліць спасылкі з базы дадзеных.";
$LANG["notify_file_not_deleted_unknown_error"] = "Быў Невядомая памылка пры спробе выдаліць гэты файл. <a href=\"#\" onclick=\"{\$js_link}\">Націсніце тут,</a> каб праігнараваць гэта паведамленне пра памылку і проста выдаліць спасылкі з базы дадзеных.";
...
$LANG["notify_install_no_db_connection"] = "Калі ласка, праверце імя базы дадзеных і Лагін інфармацыі. Хаця нам атрымалася падключыцца да базе даных гаспадара, мы не маглі падключыцца да базе дадзеных. Паведамленне пра памылку базы дадзеных вяртаюцца: <i>{\$db_select_error}</i>";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Гэты модуль быў выдалены. Заўвага: Мы не маглі выдаліць модуль з файла / папкі модуляў - вам неабходна выдаліць яго ўручную.";
...
$LANG["notify_no_user_email_fields_configured"] = "Заўвага: калі вы хочаце адправіць паведамленне на любы адрас электроннай пошты, які быў уключаны ў форме, спачатку неабходна <a href=\"{\$same_page}?page=email_settings\">наладзіць палі формы электроннай пошце.</a>";
