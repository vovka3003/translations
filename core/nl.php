...
$LANG["word_form_sp"] = "Formulier(en)";
...
$LANG["word_toolbar"] = "Werkbalk";
$LANG["word_top"] = "Bovenaan";
...
$LANG["phrase_allow_toolbar_resizing"] = "Formaat werkbalk wijzigen toestaan";
...
$LANG["phrase_one_submission_per_page"] = "E&eacute;n inzending per pagina";
...
$LANG["phrase_problems_questions_forum"] = "Problemen / Vragen? Bezoek onze forums";
...
$LANG["text_add_form_help_link"] = "Als je in de problemen tijdens deze stappen, probeer dan het uitlezen van <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">gebruikersdocumentatie</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Kopieer en plak de inhoud van de hieronder in een bestand genaamd config.php en uploaden via FTP naar de Form Tools / global folder (de map die ook een paar andere bestanden en directories, een bestand genaamd license.txt).";
...
$LANG["text_enter_license_key"] = "Om deze module te installeren, moet u uw licentiecode. Je moet zijn per e-mail deze sleutel na aankoop van de module. Als u niet ontvangen, dan kunt u altijd <a href=\"http://accounts.formtools.org\" target=\"_blank\">inloggen op uw formulier Extra-account</a> om het te sporen.";
...
$LANG["text_install_email_content_text"] = "Er is genoeg van de middelen op onze website om u te helpen de slag te gaan, met inbegrip van onze online documentatie (http://docs.formtools.org) en tutorials (http://docs.formtools.org/tutorials). Als u merkt dat u vast komt te zitten of een vraag hebt, pop van onze forums (http://forums.formtools.org) en zeg hallo.";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, Vorm Tools niet te kunnen draaien op je server. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">U kunt hier klikken</a> voor de minimale vereisten.";
...
$LANG["text_no_themes"] = "Je hebt geen gedefinieerd geen thema&#39;s. Klik op de onderstaande knop om uw thema lijst te vernieuwen, of kijk op de <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">Form Extra gebruikersdocumentatie</a> voor informatie over het toevoegen van thema&#39;s.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Het bestand is niet verwijderd omdat het niet bestaat op de verwachte locatie. <a href=\"#\" onclick=\"{\$js_link}\">Klik hier</a> om deze foutmelding te negeren en gewoon de verwijzing te verwijderen uit de database.";
$LANG["notify_file_not_deleted_permissions"] = "Het bestand is niet geschrapt, omdat het de verkeerde permissies heeft. <a href=\"#\" onclick=\"{\$js_link}\">Klik hier</a> om deze foutmelding te negeren en gewoon de verwijzing te verwijderen uit de database.";
$LANG["notify_file_not_deleted_unknown_error"] = "Er is een onbekende fout wanneer het proberen om dit bestand te verwijderen. <a href=\"#\" onclick=\"{\$js_link}\">Klik hier</a> om deze foutmelding te negeren en gewoon de verwijzing te verwijderen uit de database.";
