...
$LANG["phrase_allow_toolbar_resizing"] = "Leisti įrankių juostos dydžio keitimas";
...
$LANG["text_add_form_help_link"] = "Jei paleisti į kokių nors problemų, per šiuos veiksmus, bandykite <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">skaityti vartotojo</a> dokumentacijoje .";
...
$LANG["text_config_file_not_created_instructions"] = "Nukopijuokite ir įklijuokite šį turinį iš toliau nurodyto skyriaus į failą config.php ir įkelti per FTP forma Įrankiai / pasaulio aplanką (katalogą, taip pat yra keletas kitų failus ir katalogus, vieną failą pavadinimu License.txt).";
...
$LANG["text_enter_license_key"] = "Siekiant įdiegti šį modulį, turite įvesti savo licencijos raktą. Jums turėjo būti išsiųsta šį klavišą, po pirkimo modulio. Jei tu negali gauti, visada galite <a href=\"http://accounts.formtools.org\" target=\"_blank\">prisijungti į savo formos įrankių paskyros</a> , kad sekti jį žemyn.";
...
$LANG["text_install_email_content_text"] = "Yra daug lėšų į mūsų svetainę, kad padėtų jums pradėti, įskaitant mūsų dokumentacijos (http://docs.formtools.org) ir Tutorials (http://docs.formtools.org/tutorials). Jei radote turite problemų ar klausimų, iškylančių mūsų forumuose (http://forums.formtools.org) and say hello.";
$LANG["text_install_form_tools_server_not_supported"] = "Atsiprašome, įrankiai gali paleisti savo serverį. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Prašome spausti čia,</a> minimalius reikalavimus.";
...
$LANG["text_no_themes"] = "Jūs neturite jokių temų apibrėžta. Paspauskite mygtuką žemiau, norėdami atnaujinti savo temą sąrašo arba patikrinti informaciją apie tai, kaip pridėti temas <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">forma Įrankiai vartotojo dokumentaciją</a> .";
...
$LANG["notify_file_not_deleted_no_exist"] = "Byla nebuvo išbrauktas, nes ji nėra stovėjimo vieta tikėtis. <a href=\"#\" onclick=\"{\$js_link}\">Spauskite čia,</a> jei norite ignoruoti šį klaidos pranešimą ir tik panaikinti nuorodą iš duomenų bazės.";
$LANG["notify_file_not_deleted_permissions"] = "Byla nebuvo išbraukta, nes ji klaidingai teises. <a href=\"#\" onclick=\"{\$js_link}\">Spauskite čia,</a> jei norite ignoruoti šį klaidos pranešimą ir tik panaikinti nuorodą iš duomenų bazės.";
$LANG["notify_file_not_deleted_unknown_error"] = "Įvyko nežinoma klaida bandant pašalinti šį failą. <a href=\"#\" onclick=\"{\$js_link}\">Spauskite čia,</a> jei norite ignoruoti šį klaidos pranešimą ir tik panaikinti nuorodą iš duomenų bazės.";
