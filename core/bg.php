...
$LANG["word_advanced"] = "Разширено търсене";
$LANG["word_after"] = "След";
$LANG["word_all"] = "всички";
...
$LANG["word_blue"] = "Син";
$LANG["word_bottom"] = "Дъно";
$LANG["word_cancel"] = "Отказ";
$LANG["word_cc_c"] = "Копие:";
$LANG["word_center"] = "Център";
...
$LANG["phrase_allow_toolbar_resizing"] = "Разреши преоразмеряване на лентата с инструменти";
...
$LANG["phrase_get_more"] = "Вземете повече ...";
...
$LANG["phrase_problems_questions_forum"] = "Проблеми / Въпроси? Посетете нашия форум";
...
$LANG["text_add_form_help_link"] = "Ако се сблъскате с никакви проблеми по време на тези стъпки, опитайте се <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">да прочетете документацията</a> за потребителя.";
...
$LANG["text_config_file_not_created_instructions"] = "Копирайте съдържанието от секцията по-долу в един файл, наречен config.php и да го качите чрез FTP с формата Инструменти / глобалната папка (папката, която съдържа и няколко други файлове и директории, един файл, наречен license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Преди да продължите, ще трябва да актуализирате <b>/ теми / по подразбиране /</b> папка <b>кеш</b> да осигурява пълно четат и пишат разрешения. След като това се прави, това съобщение ще изчезне, а можете да инсталирате скрипта.";
...
$LANG["text_install_already_upgraded"] = "Ако вече сте го стартирате скрипт инсталация, изтрийте <b>/ настанявам</b> папка след това <a href=\"../\" class=\"bold\">кликнете тук, за да влезете.</a>";
...
$LANG["text_install_email_content_text"] = "Има изобилие от ресурси на нашия сайт, за да ви помогнем да започнете, включително и нашия онлайн документация (http://docs.formtools.org) и уроци (http://docs.formtools.org/tutorials). Ако откриете, че да заседнат или имате въпрос, поп от нашите форуми (http://forums.formtools.org) и да кажа здрасти.";
$LANG["text_install_form_tools_server_not_supported"] = "Съжаляваме, Формуляр инструменти няма да бъдат в състояние да работи на вашия сървър. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Моля, кликнете тук</a> за минималните изисквания.";
...
$LANG["text_must_delete_install_folder"] = "Преди да влезете в системата <b>трябва да изтриете / инсталиране / папка на вашия сървър.</b> Няма да бъде позволено да влезете в системата, докато тя е била отстранена.";
...
$LANG["text_no_themes"] = "Вие не разполагат с никакви определени теми. Щракнете върху бутона по-долу, за да опресни списъка си тема, <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">или проверете документацията за потребителя</a> Форма Инструменти за информация относно добавянето на теми.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">Щракнете тук</a> , за да се уточни, които формират полета са имейл полета, така че можете да ги насочвате във вашата електронна поща, шаблони.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Файлът не е изтрит, защото тя не съществува в очакваното място. <a href=\"#\" onclick=\"{\$js_link}\">Щракнете тук,</a> за да пренебрегнете това съобщение за грешка и просто премахнете позоваването на базата данни.";
$LANG["notify_file_not_deleted_permissions"] = "Файлът не е заличена, защото тя има грешни права. <a href=\"#\" onclick=\"{\$js_link}\">Щракнете тук,</a> за да пренебрегнете това съобщение за грешка и просто премахнете позоваването на базата данни.";
$LANG["notify_file_not_deleted_unknown_error"] = "Възникна непозната грешка при опит за изтриване на файла. <a href=\"#\" onclick=\"{\$js_link}\">Щракнете тук,</a> за да пренебрегнете това съобщение за грешка и просто премахнете позоваването на базата данни.";
...
$LANG["notify_no_user_email_fields_configured"] = "Забележка: Ако искате да изпратите електронна поща на всеки имейл адрес, който е включен във формата, трябва първо да <a href=\"{\$same_page}?page=email_settings\">конфигурирате полета за имейл.</a>";
