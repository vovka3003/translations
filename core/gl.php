...
$LANG["phrase_allow_toolbar_resizing"] = "Permitir Adaptación da barra de ferramentas";
...
$LANG["text_add_form_help_link"] = "Se ten calquera problema durante estas etapas, proba ler en <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">documentación de usuario</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Copie e pegue o contido da sección seguinte nun ficheiro chamado config.php e enviá-lo vía FTP para as ferramentas de formulario / carpeta global (no cartafol que contén tamén algúns outros arquivos e directorios, un arquivo chamado license.txt).";
...
$LANG["text_enter_license_key"] = "Co fin de instalar este módulo, ten que escribir a súa clave de licenza. Debería ser enviada esta tecla despois de mercar o módulo. Se non recibe-lo, sempre pode <a href=\"http://accounts.formtools.org\" target=\"_blank\">entrar na túa conta Tools Formulario</a> para rastrexar-lo.";
...
$LANG["text_install_email_content_text"] = "Hai unha abundancia de recursos na nosa web para axudar a comezar, incluíndo a nosa documentación on-line (http://docs.formtools.org) e tutoriais (http://docs.formtools.org/tutorials). Se cre que estar preso ou ten algunha pregunta, pop polos nosos foros (http://forums.formtools.org) e dicir Olá";
$LANG["text_install_form_tools_server_not_supported"] = "Sentímolo, ferramentas de formulario non será capaz de executar no seu servidor. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Por favor, prema aquí</a> para a requisitos mínimos.";
...
$LANG["text_no_themes"] = "Non ten ningún tema definido. Preme o botón de embaixo para actualizar a súa lista de tema ou comprobar a <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">documentación de usuario Form Tools</a> para obter información sobre a adición de temas.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">Prema aquí</a> para especificar que os campos do formulario son campos de correo-e, para que poida oriente-las nos seus modelos de correo-e.";
...
$LANG["notify_file_not_deleted_no_exist"] = "O ficheiro non foi eliminado porque non existe no lugar inesperado. <a href=\"#\" onclick=\"{\$js_link}\">Prema aquí</a> para ignorar esta mensaxe de erro e só eliminar a referencia na base de datos.";
$LANG["notify_file_not_deleted_permissions"] = "O ficheiro non foi eliminado porque non ten os permisos erradas. <a href=\"#\" onclick=\"{\$js_link}\">Prema aquí</a> para ignorar esta mensaxe de erro e só eliminar a referencia na base de datos.";
$LANG["notify_file_not_deleted_unknown_error"] = "Houbo un erro descoñecido ao tentar eliminar este ficheiro. <a href=\"#\" onclick=\"{\$js_link}\">Prema aquí</a> para ignorar esta mensaxe de erro e só eliminar a referencia na base de datos.";
