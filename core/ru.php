...
$LANG["word_advanced"] = "Расширенный";
...
$LANG["word_toolbar"] = "Панели инструментов";
$LANG["word_top"] = "Верх";
...
$LANG["phrase_allow_toolbar_resizing"] = "Разрешить изменение размеров панели инструментов";
...
$LANG["phrase_get_more"] = "Получить больше ...";
...
$LANG["phrase_problems_questions_forum"] = "Проблемы / Вопросы? Посетите наши форумы";
...
$LANG["text_add_form_help_link"] = "Если у вас возникли какие-либо проблемы во время этих шагов, попробуйте прочитать из <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">пользовательской документации</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Скопируйте и вставьте содержимое из раздела ниже в файл config.php и загрузите его через FTP к форме Инструменты / глобальные папки (папки, которая содержит также несколько других файлов и каталогов, один файл с названием license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Прежде чем продолжать, вам нужно обновить <b>/ Темы / Default /</b> папке <b>кэша</b> для обеспечения полного чтение и запись. Как только это будет сделано, это сообщение исчезнет, и вы можете установить скрипт.";
...
$LANG["text_enter_license_key"] = "Для того чтобы установить этот модуль, вы должны ввести лицензионный ключ. Вы должны были этот ключ по электронной почте после покупки модуля. Если вы не получили его, вы всегда можете <a href=\"http://accounts.formtools.org\" target=\"_blank\">войти в свой ​​аккаунт Форма инструменты</a> для отслеживания его вниз.";
...
$LANG["text_install_already_upgraded"] = "Если вы уже запустили сценарий установки, удаления <b>/ Установить</b> папку, затем <a href=\"../\" class=\"bold\">нажмите здесь, чтобы войти.</a>";
...
$LANG["text_install_email_content_text"] = "Там есть много ресурсов на нашем сайте, чтобы помочь вам начать работу, в том числе наш онлайн документацию (http://docs.formtools.org) и учебники (http://docs.formtools.org/tutorials). Если вы обнаружите вы запутаетесь или есть вопросы, наши поп-форумах (http://forums.formtools.org) и поздороваться.";
$LANG["text_install_form_tools_server_not_supported"] = "К сожалению, форма инструменты не будут иметь возможность запускать на вашем сервере. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Пожалуйста, нажмите здесь</a> для минимальных требований.";
...
$LANG["text_must_delete_install_folder"] = "Прежде чем войти <b>Вы должны удалить / установка / папки на вашем сервере.</b> Вам не будет разрешено войти в систему, пока она не была удалена.";
...
$LANG["text_no_themes"] = "У вас нет ни одной темы определена. Нажмите на кнопку ниже, чтобы освежить свою тему списке, или проверить <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">пользователя Форма Инструменты документации</a> для получения информации о добавлении темы.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Файл не был удален, потому что не существует на месте ожидал. <a href=\"#\" onclick=\"{\$js_link}\">Нажмите здесь,</a> чтобы проигнорировать это сообщение об ошибке и просто удалить ссылки из базы данных.";
$LANG["notify_file_not_deleted_permissions"] = "Файл не был удален, поскольку он имеет неправильные права. <a href=\"#\" onclick=\"{\$js_link}\">Нажмите здесь,</a> чтобы проигнорировать это сообщение об ошибке и просто удалить ссылки из базы данных.";
$LANG["notify_file_not_deleted_unknown_error"] = "Был Неизвестная ошибка при попытке удалить этот файл. <a href=\"#\" onclick=\"{\$js_link}\">Нажмите здесь,</a> чтобы проигнорировать это сообщение об ошибке и просто удалить ссылки из базы данных.";
...
$LANG["notify_install_no_db_connection"] = "Пожалуйста, проверьте имя базы данных и Логин информации. Хотя нам удалось подключиться к базе данных хозяина, мы не могли подключиться к базе данных. Сообщение об ошибке базы данных возвращаемых: <i>{\$db_select_error}</i>";
...
$LANG["notify_no_user_email_fields_configured"] = "Примечание: если вы хотите отправить сообщение на любой адрес электронной почты, который был включен в форме, сначала необходимо <a href=\"{\$same_page}?page=email_settings\">настроить поля формы электронной почте.</a>";
