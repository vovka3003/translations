...
$LANG["phrase_allow_toolbar_resizing"] = "Izin Araç Çubuğu yeniden boyutlandırma";
...
$LANG["text_config_file_not_created_instructions"] = "Kopyalayıp aşağıdaki bölümde bir dosya içine config.php adlı içeriğini yapıştırın ve FTP yoluyla Formu Araçlar yükleyin / küresel klasörü (klasör aynı zamanda birkaç diğer dosyaları ve dizinleri içerir, bir license.txt) olarak adlandırılan dosya.";
...
$LANG["text_enter_license_key"] = "Bu modül yüklemek için, lisans anahtarını girmeniz gerekir. Modül satın aldıktan sonra bu anahtarı e-posta ile olmalıdır. Eğer almadıysanız, her zaman <a href=\"http://accounts.formtools.org\" target=\"_blank\">Formu Araçlar hesaba giriş</a> izini.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Çünkü yeri beklenen de yok dosya silinmedi. <a href=\"#\" onclick=\"{\$js_link}\">Tıklayın</a> ve bu hata iletisini yok sayıp sadece veritabanından başvurusunu kaldırın.";
$LANG["notify_file_not_deleted_permissions"] = "Çünkü yanlış izinlere sahip dosya silinmedi. <a href=\"#\" onclick=\"{\$js_link}\">Tıklayın</a> ve bu hata iletisini yok sayıp sadece veritabanından başvurusunu kaldırın.";
$LANG["notify_file_not_deleted_unknown_error"] = "Orada bilinmeyen bir hata bu dosyayı silmek için çalışıyordu. <a href=\"#\" onclick=\"{\$js_link}\">Tıklayın</a> ve bu hata iletisini yok sayıp sadece veritabanından başvurusunu kaldırın.";
