...
$LANG["word_advanced"] = "Напредна претрага";
$LANG["word_after"] = "По";
$LANG["word_all"] = "сите";
...
$LANG["phrase_allow_toolbar_resizing"] = "Дозволете Toolbar Resizing";
...
$LANG["phrase_get_more"] = "Добијам повеќе ...";
...
$LANG["text_add_form_help_link"] = "Ако наидете на никакви проблеми за време на овие чекори, обидете се читање на <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">корисникот документација</a> .";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Пред да продолжиш, ќе треба да го обновите вашиот <b>/ темите / default / кеш</b> папка да се овозможи целосна чита и пишува дозволи. Откако ова е направено, ова порака ќе исчезне и ќе можеш да инсталираш скрипта.";
...
$LANG["text_enter_license_key"] = "Со цел да го инсталирате овој модул, мора да го внесете вашиот лиценцен клуч. Треба да се маил ова копче по купувањето на модулот. Ако не го добијат, секогаш можете да <a href=\"http://accounts.formtools.org\" target=\"_blank\">влезете во вашиот формулар Алатки сметка</a> да го пронајде.";
...
$LANG["text_install_already_upgraded"] = "Ако веќе имате скрипта за стартување на инсталацијата, избришете <b>/ инсталирате</b> фолдер тогаш <a href=\"../\" class=\"bold\">кликнете тука за да се логирате.</a>";
...
$LANG["text_install_email_content_text"] = "Има многу ресурси на нашиот веб сајт за да ви помогнеме да започнете, вклучително и нашата онлајн документација (http://docs.formtools.org) и упатства (http://docs.formtools.org/tutorials). Ако најдете вие заглавуваат или имаш прашање, од нашите поп-форуми (http://forums.formtools.org) и кажам здраво.";
$LANG["text_install_form_tools_server_not_supported"] = "За жал, формата Алатки не ќе можат да работат на вашиот сервер. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Ве молиме кликнете овде</a> за минималните барања.";
...
$LANG["text_must_delete_install_folder"] = "Пред да влезете во <b>тебе мора да избришете / install / директориумот на вашиот сервер.</b> Можете нема да им биде дозволено да влезете додека не се отстрани.";
...
$LANG["text_no_themes"] = "Вие не имате било какви теми дефинирани. Кликнете на копчето подолу за да го освежи вашата тема листа, или проверка на <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">формата Алатки корисник документација</a> за информации за додавање на теми.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">Кликни тука за</a> да се определи кои полиња се е-мејл области, па можете да ги наведете во вашата e-mail шаблони.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Датотеката не е избришан, бидејќи не постои на локација што се очекуваше. <a href=\"#\" onclick=\"{\$js_link}\">Кликни тука за</a> да ја игнорирате оваа порака за грешка и отстранување на упатување само од базата на податоци.";
$LANG["notify_file_not_deleted_permissions"] = "Датотеката не е избришан, бидејќи таа има погрешна дозволи. <a href=\"#\" onclick=\"{\$js_link}\">Кликни тука за</a> да ја игнорирате оваа порака за грешка и отстранување на упатување само од базата на податоци.";
$LANG["notify_file_not_deleted_unknown_error"] = "Имаше некоја непозната грешка при обидот да ја избришете оваа датотека. <a href=\"#\" onclick=\"{\$js_link}\">Кликни тука за</a> да ја игнорирате оваа порака за грешка и отстранување на упатување само од базата на податоци.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Модулот е деинсталиран. Забелешка: не можеме да ги избришете модул од вашата / modules папка - ќе треба да го избришете рачно.";
...
$LANG["notify_no_user_email_fields_configured"] = "Забелешка: ако сакате да испратите е-пошта до сите е-мејл адреса, кој беше вклучен во форма, прво треба да <a href=\"{\$same_page}?page=email_settings\">одбереш форма мејл полиња.</a>";
