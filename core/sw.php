...
$LANG["word_display"] = "Onyesha";
$LANG["word_documentation"] = "Documentation";
$LANG["word_done"] = "Done";
$LANG["word_download"] = "Pakua";
...
$LANG["phrase_allow_toolbar_resizing"] = "Ruhusu Toolbar Resizing";
...
$LANG["text_config_file_not_created_instructions"] = "Nakili na kuweka yaliyomo kutoka sehemu ya chini kwenye faili inayoitwa config.php na upload it via FTP na kidato Tools / global folder (the folder ambayo pia ina nyingine chache files na telefonkataloger, faili mmoja aitwaye license.txt).";
...
$LANG["text_install_email_content_text"] = "Kuna mengi ya rasilimali kwenye tovuti yetu ili kukusaidia kupata kuanza, pamoja na nyaraka online wetu (http://docs.formtools.org) na tutorials (http://docs.formtools.org/tutorials). Ukikuta kupata kukwama au swali, pop na vikao wetu (http://forums.formtools.org) na kusema hello.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Faili haijawahi ilifutwa kwa sababu haipo katika eneo ilivyotarajiwa. <a href=\"#\" onclick=\"{\$js_link}\">Bonyeza hapa</a> kupuuzia ujumbe wa kosa hili na kuondoa tu rejea kutoka database.";
$LANG["notify_file_not_deleted_permissions"] = "Faili haijawahi ilifutwa kwa sababu ina makosa permissions. <a href=\"#\" onclick=\"{\$js_link}\">Bonyeza hapa</a> kupuuzia ujumbe wa kosa hili na kuondoa tu rejea kutoka database.";
$LANG["notify_file_not_deleted_unknown_error"] = "Kulikuwa na hitilafu isiyojulikana wakati akijaribu delete faili hii. <a href=\"#\" onclick=\"{\$js_link}\">Bonyeza hapa</a> kupuuzia ujumbe wa kosa hili na kuondoa tu rejea kutoka database.";
