...
$LANG["word_display"] = "Visa";
$LANG["word_documentation"] = "Dokumentation";
$LANG["word_done"] = "Klar";
$LANG["word_download"] = "Ladda ner";
...
$LANG["word_errors"] = "Följande fel uppstod";
...
$LANG["word_toolbar"] = "Verktygslåda";
$LANG["word_top"] = "Överst";
...
$LANG["phrase_allow_toolbar_resizing"] = "Tillåt storleksändring av verktygsraden";
...
$LANG["text_add_form_help_link"] = "Om du stöter på några problem under dessa steg, läs gärna vår <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">användardokumentation</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Kopiera och klistra in innehållet från nedanstående text i en ny fil som du döper till config.php. Ladda sedan upp den via FTP till din installation av Form Tools, katalogen /global (den katalogen innehåller också några andra filer och underkataloger samt license.txt).";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Innan du fortsätter behöver du uppdatera din katalog <strong>/themes/default/cache</strong> till att tillåta fulla läs- och skrivrättigheter. När det väl är gjort kommer detta meddelande att försvinna och du kan installera scriptet.";
...
$LANG["text_install_email_content_text"] = "Det finns massor med resurser på din webbplats som kan hjälpa dig komma igång, inklusive vår onlinedokumentation (http://docs.formtools.org) och guider (http://docs.formtools.org/tutorials). Om du har kört fast eller har någon fråga så titta förbi våra diskussionsforum (http://forums.formtools.org) och säg hej.";
$LANG["text_install_form_tools_server_not_supported"] = "Tyvärr så kommer inte Form Tools att kunna köras på din server. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Läs om minimikraven här</a>.";
...
$LANG["text_no_themes"] = "Du har inga definierade teman. Klicka på knappen nedan för att uppdatera din temalista eller läs mer i <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">Form Tools användardokumentation</a> kring hur du gör för att lägga till teman.";
...
$LANG["notify_problem_upgrading"] = "Det uppstod ett problem med uppgraderingen till <b> {\$version} </ b>:";
