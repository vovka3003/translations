...
$LANG["phrase_allow_toolbar_resizing"] = "Zgoda Toolbar rozmiaru";
...
$LANG["text_add_form_help_link"] = "Jeśli napotkasz jakiekolwiek problemy podczas czynności, spróbuj odczytywania <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">dokumentacji użytkownika</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Skopiuj i wklej zawartość z sekcji poniżej w pliku o nazwie config.php i przesłać za pośrednictwem protokołu FTP do formularza Narzędzia / Światowy katalog (folder zawiera również kilka innych plików i katalogów, jeden plik o nazwie license.txt).";
...
$LANG["text_enter_license_key"] = "W celu instalacji tego modułu, należy wprowadzić klucz licencyjny. Trzeba było wysłane ten klucz po zakupie modułu. Jeśli nie otrzymałeś, zawsze można <a href=\"http://accounts.formtools.org\" target=\"_blank\">zalogować się na koncie Narzędzia Formularz</a> do śledzenia go.";
...
$LANG["text_install_email_content_text"] = "Istnieje mnóstwo zasobów na naszej stronie internetowej, aby pomóc w rozpoczęciu, w tym nasz dokumentacji (http://docs.formtools.org) i tutoriale (http://docs.formtools.org/tutorials). Jeśli znajdziesz gdzieś utkniesz lub masz pytanie, pop naszym forum (http://forums.formtools.org) i powiedzieć cześć.";
$LANG["text_install_form_tools_server_not_supported"] = "Przykro nam, Narzędzia Formularz nie będzie w stanie uruchomić na serwerze. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Proszę kliknąć tutaj</a> na minimalne wymagania.";
...
$LANG["text_no_themes"] = "Nie masz żadnych tematów zdefiniowane. Kliknij przycisk poniżej, aby odświeżyć listę tematów, lub sprawdzić <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">Formularz użytkownika Narzędzia dokumentacji</a> dla informacji na temat dodawania motywów.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Plik nie został usunięty, ponieważ nie istnieje w oczekiwanym miejscu. <a href=\"#\" onclick=\"{\$js_link}\">Kliknij tutaj,</a> aby zignorować ten błąd i po prostu usunąć odniesienie do bazy danych.";
$LANG["notify_file_not_deleted_permissions"] = "Plik nie został usunięty, ponieważ ma złe uprawnienia. <a href=\"#\" onclick=\"{\$js_link}\">Kliknij tutaj,</a> aby zignorować ten błąd i po prostu usunąć odniesienie do bazy danych.";
$LANG["notify_file_not_deleted_unknown_error"] = "Wystąpił nieznany błąd podczas próby usunięcia tego pliku. <a href=\"#\" onclick=\"{\$js_link}\">Kliknij tutaj,</a> aby zignorować ten błąd i po prostu usunąć odniesienie do bazy danych.";
