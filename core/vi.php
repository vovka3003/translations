...
$LANG["word_errors"] = "Lỗi";
$LANG["word_examples_c"] = "Ví dụ:";
$LANG["word_excel"] = "Excel";
$LANG["word_expert"] = "Chuyên viên";
...
$LANG["word_toolbar"] = "Thanh công cụ";
$LANG["word_top"] = "Đỉnh";
...
$LANG["phrase_allow_toolbar_resizing"] = "Thanh công cụ cho phép Thay đổi kích thước";
...
$LANG["text_add_form_help_link"] = "Nếu bạn chạy vào bất kỳ rắc rối trong các bước sau, hãy thử đọc <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">tài liệu hướng dẫn người sử dụng</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Sao chép và dán nội dung từ phần dưới đây vào tập tin có tên là config.php và tải lên qua FTP tới Tools Mẫu / thư mục trên toàn cầu (các thư mục đó cũng có một vài tập tin và thư mục khác, một trong những tập tin gọi là license.txt).";
...
$LANG["text_enter_license_key"] = "Để cài đặt mô-đun này, bạn phải nhập key bản quyền của bạn. Bạn cần phải có được gửi qua thư điện tử quan trọng này sau khi mua các mô-đun. Nếu bạn không nhận được nó, bạn luôn có thể <a href=\"http://accounts.formtools.org\" target=\"_blank\">đăng nhập vào tài khoản Công cụ Form của</a> bạn để theo dõi nó xuống .";
...
$LANG["text_install_email_content_text"] = "Có rất nhiều tài nguyên trên trang web của chúng tôi để giúp bạn bắt đầu, bao gồm các tài liệu trực tuyến của chúng tôi (http://docs.formtools.org) và hướng dẫn (http://docs.formtools.org/tutorials). Nếu bạn tìm thấy bạn gặp khó khăn hay có một câu hỏi, pop của diễn đàn của chúng tôi (http://forums.formtools.org) và chào hỏi.";
$LANG["text_install_form_tools_server_not_supported"] = "Xin lỗi, công cụ Form không sẽ có thể chạy trên máy chủ của bạn <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">. Xin vui lòng bấm vào đây</a> để yêu cầu tối thiểu .";
...
$LANG["text_no_themes"] = "Bạn không có bất kỳ chủ đề được xác định. Nhấp vào nút dưới đây để làm mới danh sách chủ đề của bạn, hoặc kiểm tra các tài <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">liệu hướng dẫn Mẫu</a> người sử dụng công cụ cho các thông tin về việc thêm các chủ đề.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Các tập tin chưa được xóa bởi vì nó không tồn tại địa điểm dự kiến sẽ <a href=\"#\" onclick=\"{\$js_link}\">Click vào đây</a> để bỏ qua các thông báo lỗi này và chỉ cần loại bỏ các tham chiếu từ cơ sở dữ liệu..";
$LANG["notify_file_not_deleted_permissions"] = "Các tập tin chưa được xóa bởi vì nó có quyền sai <a href=\"#\" onclick=\"{\$js_link}\">Click vào đây</a> để bỏ qua các thông báo lỗi này và chỉ cần loại bỏ các tham chiếu từ cơ sở dữ liệu..";
$LANG["notify_file_not_deleted_unknown_error"] = "Có một lỗi không rõ khi cố gắng xóa file này <a href=\"#\" onclick=\"{\$js_link}\">Click vào đây.</a> Bỏ qua lỗi này và chỉ cần loại bỏ các tham chiếu từ cơ sở dữ liệu.";
...
$LANG["notify_no_user_email_fields_configured"] = "Lưu ý: nếu bạn muốn gửi email đến bất kỳ địa chỉ email mà đã được bao gồm trong các biểu mẫu, trước tiên bạn cần phải <a href=\"{\$same_page}?page=email_settings\">cấu hình các trường email mẫu.</a>";
