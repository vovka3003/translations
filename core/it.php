...
$LANG["word_toolbar"] = "Barra strumenti";
$LANG["word_top"] = "In alto";
...
$LANG["phrase_allow_toolbar_resizing"] = "Consenti il ridimensionamento della barra";
...
$LANG["phrase_problems_questions_forum"] = "Problemi / Domande? Visita il nostro forum";
...
$LANG["text_add_form_help_link"] = "Se incappate in qualche problema durante questi passaggi, provare a leggere le <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">documentazione per l&#39;utente</a> .";
...
$LANG["text_config_file_not_created_instructions"] = "Copia e incolla il contenuto dalla sezione di seguito in un file chiamato config.php e caricarlo via FTP per gli Strumenti di Form / cartella globale (la cartella che contiene anche un file di pochi altri e directory, un file chiamato License.txt).";
...
$LANG["text_enter_license_key"] = "Per installare questo modulo, è necessario inserire il codice di licenza. Lei avrebbe dovuto essere inviato via email questo tasto dopo l&#39;acquisto del modulo. Se non avete ricevuto, è sempre possibile <a href=\"http://accounts.formtools.org\" target=\"_blank\">accedere al vostro conto Modulo Strumenti</a> per rintracciarlo.";
...
$LANG["text_install_email_content_text"] = "C&#39;è un sacco di risorse del nostro sito per aiutarti a iniziare, compresa la nostra documentazione in linea (http://docs.formtools.org) ed esercitazioni (http://docs.formtools.org/tutorials). Se trovi ti trovi in difficoltà o che hanno una domanda, pop dal nostro forum (http://forums.formtools.org) e dire ciao.";
$LANG["text_install_form_tools_server_not_supported"] = "Ci dispiace, strumenti Form non sarà in grado di funzionare sul vostro server. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Clicca qui</a> per i requisiti minimi.";
...
$LANG["text_no_themes"] = "Non è necessario alcun temi definiti. Clicca sul bottone qui sotto per aggiornare l&#39;elenco tema, oppure controllare il <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">modulo di documentazione per l&#39;utente strumenti</a> per informazioni sull&#39;aggiunta di temi.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Il file non è stato soppresso perché non esiste nella posizione prevista. <a href=\"#\" onclick=\"{\$js_link}\">Clicca qui</a> per ignorare questo messaggio di errore ed è sufficiente rimuovere il riferimento dal database.";
$LANG["notify_file_not_deleted_permissions"] = "Il file non è stato soppresso perché ha i permessi sbagliati. <a href=\"#\" onclick=\"{\$js_link}\">Clicca qui</a> per ignorare questo messaggio di errore ed è sufficiente rimuovere il riferimento dal database.";
$LANG["notify_file_not_deleted_unknown_error"] = "Si è verificato un errore sconosciuto durante il tentativo di eliminare questo file. <a href=\"#\" onclick=\"{\$js_link}\">Clicca qui</a> per ignorare questo messaggio di errore ed è sufficiente rimuovere il riferimento dal database.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Il modulo è stato disinstallato. Nota: non è stato possibile cancellare il modulo dalla vostra cartella /modules - dovete compiere la cancellazione manualmente.";
