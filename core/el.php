...
$LANG["phrase_allow_toolbar_resizing"] = "Επιτρέψτε Toolbar Resizing";
...
$LANG["phrase_get_more"] = "Πάρτε περισσότερα ...";
...
$LANG["text_add_form_help_link"] = "Αν αντιμετωπίσετε οποιοδήποτε πρόβλημα κατά τη διάρκεια αυτών των βημάτων, προσπαθήστε να διαβάσετε τα <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">έγγραφα των χρηστών</a> .";
...
$LANG["text_default_theme_cache_folder_not_writable"] = "Πριν συνεχίσουμε, θα πρέπει να ενημερώσετε <b>/ θέματα</b> σας <b>/ default /</b> φάκελο <b>cache</b> για να επιτρέψει την πλήρη δικαιώματα ανάγνωσης και εγγραφής. Μόλις γίνει αυτό, αυτό το μήνυμα θα εξαφανιστεί και μπορείτε να εγκαταστήσετε το script.";
...
$LANG["text_install_already_upgraded"] = "Εάν έχετε ήδη εκτελέσει το script εγκατάστασης, η διαγραφή <b>/ εγκατάσταση</b> φάκελο στη συνέχεια, <a href=\"../\" class=\"bold\">κάντε κλικ εδώ για να συνδεθείτε.</a>";
...
$LANG["text_install_email_content_text"] = "Υπάρχει αφθονία των πόρων στην ιστοσελίδα μας για να σας βοηθήσει να ξεκινήσετε, συμπεριλαμβανομένων ηλεκτρονική τεκμηρίωση μας (http://docs.formtools.org) και tutorials (http://docs.formtools.org/tutorials). Αν βρείτε έχετε κολλήσει ή έχετε κάποια ερώτηση, ποπ φόρουμ μας (http://forums.formtools.org) και να πω γεια.";
$LANG["text_install_form_tools_server_not_supported"] = "Λυπούμαστε, Εργαλεία φόρμας δεν θα είναι σε θέση να τρέξει στον server σας. <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">Παρακαλώ κάντε κλικ εδώ</a> για τις ελάχιστες απαιτήσεις.";
...
$LANG["text_must_delete_install_folder"] = "Πριν να συνδεθείτε <b>θα πρέπει να διαγράψετε το / εγκατάσταση / φάκελο του διακομιστή σας.</b> Δεν θα επιτρέπεται να συνδεθείτε μέχρις ότου αφαιρεθεί.";
...
$LANG["text_no_themes"] = "Δεν έχετε κανένα θέματα που ορίζονται. Κάντε κλικ στο κουμπί παρακάτω για να ανανεώσετε τον κατάλογο το θέμα σας, ή να ελέγξετε το <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">έντυπο τεκμηρίωση χρήστη Εργαλεία</a> για πληροφορίες σχετικά με την προσθήκη θεμάτων.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">Κάντε κλικ εδώ</a> για να καθορίσετε ποια πεδία της φόρμας είναι τα πεδία email, ώστε να μπορείτε να τους στόχο σε πρότυπα e-mail σας.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Το αρχείο δεν έχει διαγραφεί, διότι δεν υπάρχει στο αναμενόμενο η τοποθεσία. <a href=\"#\" onclick=\"{\$js_link}\">Κάντε κλικ εδώ για</a> να αγνοήσετε αυτό το μήνυμα λάθους και μόλις αφαιρέσετε την αναφορά από τη βάση δεδομένων.";
$LANG["notify_file_not_deleted_permissions"] = "Το αρχείο δεν έχει διαγραφεί, διότι έχει λάθος δικαιώματα. <a href=\"#\" onclick=\"{\$js_link}\">Κάντε κλικ εδώ</a> για να αγνοήσετε αυτό το μήνυμα λάθους και μόλις αφαιρέσετε την αναφορά από τη βάση δεδομένων.";
$LANG["notify_file_not_deleted_unknown_error"] = "Υπήρξε ένα άγνωστο σφάλμα κατά την προσπάθεια να διαγράψετε αυτό το αρχείο. <a href=\"#\" onclick=\"{\$js_link}\">Πατήστε εδώ για</a> να αγνοήσετε αυτό το μήνυμα λάθους και μόλις αφαιρέσετε την αναφορά από τη βάση δεδομένων.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Η ενότητα έχει απεγκατασταθεί. Σημείωση: δεν θα μπορούσαμε να διαγράψετε την ενότητα από / φάκελο ενότητες σας - θα χρειαστεί να το διαγράψετε χειροκίνητα.";
...
$LANG["notify_no_user_email_fields_configured"] = "Σημείωση: αν θέλετε να στείλετε ένα ηλεκτρονικό ταχυδρομείο σε οποιαδήποτε διεύθυνση ηλεκτρονικού ταχυδρομείου που περιέχονται στο έντυπο, πρέπει πρώτα να <a href=\"{\$same_page}?page=email_settings\">ρυθμίσετε τα πεδία φόρμα e-mail.</a>";
