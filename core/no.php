...
$LANG["word_toolbar"] = "Verktøylinje";
$LANG["word_top"] = "Topp";
...
$LANG["phrase_allow_toolbar_resizing"] = "Tillat Toolbar Resizing";
...
$LANG["text_config_file_not_created_instructions"] = "Kopier og lim inn innholdet fra avsnittet nedenfor i en fil som heter config.php og laste den opp via FTP til skjema Verktøy / global mappen (mappen som også inneholder noen andre filer og kataloger, arkiv ett kalt license.txt).";
...
$LANG["text_enter_license_key"] = "For å installere denne modulen, må du skrive inn din lisensnøkkel. Du skulle ha vært sendt denne nøkkelen etter kjøp modulen. Hvis du ikke mottar det, kan du alltids <a href=\"http://accounts.formtools.org\" target=\"_blank\">logge deg inn på Skjema Tools konto</a> for å spore det ned.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Filen er ikke blitt slettet fordi den ikke finnes på stedet forventet. <a href=\"#\" onclick=\"{\$js_link}\">Klikk her</a> for å ignorere denne feilmeldingen og bare fjerne referansen fra databasen.";
$LANG["notify_file_not_deleted_permissions"] = "Filen er ikke blitt slettet, fordi den har feil rettigheter. <a href=\"#\" onclick=\"{\$js_link}\">Klikk her</a> for å ignorere denne feilmeldingen og bare fjerne referansen fra databasen.";
$LANG["notify_file_not_deleted_unknown_error"] = "Det oppstod en ukjent feil når du prøver å slette denne filen. <a href=\"#\" onclick=\"{\$js_link}\">Klikk her</a> for å ignorere denne feilmeldingen og bare fjerne referansen fra databasen.";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "Modulen er avinstallert. Merk: vi ikke kunne slette modulen fra / moduler folder - må du slette den manuelt.";
