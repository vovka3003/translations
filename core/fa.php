...
$LANG["text_add_form_help_link"] = "اگر شما را به هر گونه مشکل در طی این مراحل اجرا ، سعی کنید <a href=\"http://docs.formtools.org/userdoc2_1?page=add_form\" target=\"_blank\">به خواندن</a> مستندات کاربر.";
...
$LANG["text_config_file_not_created_instructions"] = "کپی کنید و آن مطالب را از قسمت زیر را به یک فایل با نام config.php و آن را از طریق FTP به ابزار فرم ارسال / پوشه جهانی (پوشه که همچنین دارای چند فایل و دایرکتوری دیگر ، یک فایل با نام license.txt).";
...
$LANG["text_install_already_upgraded"] = "اگر تا کنون اسکریپت نصب ، اجرا حذف <b>/ نصب</b> پوشه و سپس <a href=\"../\" class=\"bold\">اینجا را کلیک کنید تا وارد بخش مدیریت شوید.</a>";
...
$LANG["text_install_email_content_text"] = "&#39;sمقدار زیادی از منابع وجود دارد در وب سایت ما ، برای کمک به شما برای شروع ، از جمله (آنلاین) مستندات ما (http://docs.formtools.org) و آموزش (http://docs.formtools.org/tutorials). اگر شما مشاهده می کنید گیر و یا سوالی دارید ، پاپ توسط انجمن ما (http://forums.formtools.org) و بگو سلام.";
$LANG["text_install_form_tools_server_not_supported"] = "با عرض پوزش ، ابزار فرم خواهد شد قادر به بر روی سرور خود اجرا <a href=\"http://docs.formtools.org/userdoc2_1/?page=system_requirements\" target=\"_blank\">کنید ، لطفا اینجا را</a> کلیک کنید برای حداقل مورد نیاز.";
...
$LANG["text_must_delete_install_folder"] = "قبل از اینکه شما را در <b>حذف شما باید</b> ورود به سیستم <b>/ نصب / پوشه بر روی سرور خود شما</b> نخواهد شد اجازه ورود به سیستم تا از آن حذف شده است.";
...
$LANG["text_no_themes"] = "انجام هر گونه تم های تعریف شده نیست. به روز کردن لیست موضوع خود را چک کرده و <a href=\"http://docs.formtools.org/userdoc2_1/?page=themes\">یا ابزار فرم مستندات کاربر</a> برای کسب اطلاعات در مورد اضافه کردن تم روی دکمه زیر کلیک کنید.";
...
$LANG["notify_edit_email_fields_link"] = "<a href=\"edit.php?page=email_settings\">اینجا را کلیک کنید</a> تا مشخص کنید که کدام فیلد های فرم میدانهای ایمیل ، بنابراین شما می توانید آنها را در قالب پست الکترونیکی شما را در هدف قرار دادن .";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "ماژول بوده است uninstalled. توجه : می توان از ماژول / پوشه ماژول های خود را حذف کنید -- شما باید آن را حذف کنی.";
...
$LANG["notify_no_user_email_fields_configured"] = "توجه : اگر شما میخواهید ارسال ایمیل به هر آدرس ایمیل که در فرم گنجانده شد ، برای بار اول شما را به <a href=\"{\$same_page}?page=email_settings\">پیکربندی</a> نیاز به <a href=\"{\$same_page}?page=email_settings\">زمینه های شکل ایمیل.</a>";
