...
$LANG["word_display"] = "표시";
$LANG["word_documentation"] = "문서";
$LANG["word_done"] = "완료";
$LANG["word_download"] = "다운로드";
...
$LANG["phrase_allow_toolbar_resizing"] = "허용 툴바의 크기";
...
$LANG["text_config_file_not_created_instructions"] = "복사하고 아래의 섹션에서 config.php라는 파일에 내용을 붙여 및 FTP를 통해 양식 도구에 업로드 / 세계 폴더 (폴더는 또한 몇 가지 다른 파일과 디렉토리를 포함, 하나 license.txt)라는 파일을 엽니다.";
...
$LANG["text_enter_license_key"] = "이 모듈을 설치하기 위해서는, 귀하의 라이센스 키를 입력해야합니다. 당신은 모듈을 구입 후 열쇠를 이메일로되어 있어야합니다. 당신이 그것을받지 못한 경우, 당신은 항상 할 수 <a href=\"http://accounts.formtools.org\" target=\"_blank\">양식 도구 계정에 로그인</a> 을 추적할 수 있습니다.";
...
$LANG["notify_file_not_deleted_no_exist"] = "때문에 위치를 예상 존재하지 않는 파일이 삭제되지 않았습니다. <a href=\"#\" onclick=\"{\$js_link}\">여기를 클릭하여이</a> 오류 메시지를 무시하고 그냥 데이터베이스에서 참조를 제거할 수있습니다.";
$LANG["notify_file_not_deleted_permissions"] = "때문에 잘못된 권한을 가진 파일이 삭제되지 않았습니다. <a href=\"#\" onclick=\"{\$js_link}\">여기를 클릭하여이</a> 오류 메시지를 무시하고 그냥 데이터베이스에서 참조를 제거할 수있습니다.";
$LANG["notify_file_not_deleted_unknown_error"] = "거기에 알 수없는 오류가 발생하면이 파일을 삭제하려고했습니다. <a href=\"#\" onclick=\"{\$js_link}\">여기를 클릭하여이</a> 오류 메시지를 무시하고 그냥 데이터베이스에서 참조를 제거할 수있습니다.";
