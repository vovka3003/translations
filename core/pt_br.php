...
$LANG["word_display"] = "Visualização";
...
$LANG["word_form_sp"] = "Formulário(s)";
...
$LANG["word_toolbar"] = "Barra de ferramentas";
$LANG["word_top"] = "Topo";
...
$LANG["phrase_allow_toolbar_resizing"] = "Permitir Reajuste da Barra de Ferramentas";
...
$LANG["text_config_file_not_created_instructions"] = "Copie e cole o conteúdo da seção abaixo em um arquivo chamado config.php. Faça o upload via FTP para a pasta global folder dentro de sua instalação do form tools (esta pasta também contém alguns outros arquivos e diretórios, um deles chamado licence.txt).";
...
$LANG["notify_module_uninstalled_files_not_deleted"] = "O módulo foi desinstalado. Nota: nós não poderíamos excluir o módulo de sua pasta /modules - você vai precisar excluí-la manualmente.";
