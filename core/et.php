...
$LANG["word_toolbar"] = "Tööriistariba";
$LANG["word_top"] = "Üleval";
...
$LANG["phrase_allow_toolbar_resizing"] = "Laske tööriistariba suuruse muutmine";
...
$LANG["text_config_file_not_created_instructions"] = "Kopeeri ja kleebi sisu ei jagu allpool toodud fail nimega config.php ja laadige see FTP kaudu vorm Tööriistad ja maailma kaust (kaust, mis sisaldab ka mõningaid muid faile ja katalooge, üks fail nimega license.txt).";
...
$LANG["text_enter_license_key"] = "Selleks, et paigaldada see moodul, peate sisestama oma võti. Sa oleks pidanud saadetakse seda võtit pärast ostu mooduli. Kui te ei saanud, võite alati <a href=\"http://accounts.formtools.org\" target=\"_blank\">sisse logida vorm Tools konto</a> jälgida seda alla.";
...
$LANG["notify_file_not_deleted_no_exist"] = "Faili ei ole kustutatud, kuna seda ei ole olemas kohas oodata. <a href=\"#\" onclick=\"{\$js_link}\">Klõpsake siin</a> ignoreerida selle vea teade ja lihtsalt kõrvaldada viide andmebaasist.";
$LANG["notify_file_not_deleted_permissions"] = "Faili ei ole kustutatud, kuna see on vale õigused. <a href=\"#\" onclick=\"{\$js_link}\">Klõpsake siin</a> ignoreerida selle vea teade ja lihtsalt kõrvaldada viide andmebaasist.";
$LANG["notify_file_not_deleted_unknown_error"] = "Oli tundmatu viga, kui nad üritavad selle faili kustutamiseks. <a href=\"#\" onclick=\"{\$js_link}\">Klõpsake siin</a> ignoreerida selle vea teade ja lihtsalt kõrvaldada viide andmebaasist.";
